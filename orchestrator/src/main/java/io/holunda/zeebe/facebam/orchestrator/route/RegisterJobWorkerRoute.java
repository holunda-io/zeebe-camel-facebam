...
import static io.holunda.zeebe.facebam.orchestrator.route.ZeebeRoute.Suffix.register;
...
public class RegisterJobWorkerRoute extends ZeebeRoute{
  ...
  protected RegisterJobWorkerRoute(OrchestratorConfigurationProperties properties, ObjectMapper objectMapper) {
    super(properties);
